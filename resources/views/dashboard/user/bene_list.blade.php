@extends('dashboard.user.template')
   ...
   @section('title','Beneficiary List | User')
              ...
              <div class="col-lg-12 grid-margin stretch-card">
                <div class="card">
                  ...
                  @if(session('success'))<span style="background-color:#c8ffc8; color:green;padding:6px 12px;margin-bottom:10px;">{{session('success')}}</span>@endif
                    ...
                    <p class="card-description"> List of<code>Beneficiary</code>created by<code>You</code>
                    </p>
                    <table class="table table-bordered table-striped">
                      ...
                      <tr>
                         ...
                         <td> <a href="{{'delete/benelist/'.$x->id}}" class="btn btn-fw" style="background-color:red; color:white;" onclick="return confirm('Are you sure you want to delete this beneficiary?');">Delete</a></td>
